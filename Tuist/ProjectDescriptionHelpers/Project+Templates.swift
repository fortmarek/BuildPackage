...
extension Project {
    ...
    public static func app(name: String, packages: [Package] = [], platform: Platform, dependencies: [TargetDependency] = []) -> Project {
        return self.project(name: name, packages: packages, product: .app, platform: platform, dependencies: dependencies, infoPlist: [
